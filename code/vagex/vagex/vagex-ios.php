...
class VagexCheater {
    ...
    const VAGEX_URL_R = 'http://vagex.com/iupdater2.php';
	...
	private $url;
    private $userid;
	private $ua = 'Mozilla/5.0 (iPhone; CPU iPhone OS 9_3_3 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13G34 Safari/601.1';
    

    function __construct() {
        $this->http = new HttpReq();
        $this->http->setUserAgent($this->ua); //默认ua
...
//				echo "ls:".$this->http->response['body']."\n\n\n\n";
    ...
    */		
    function update_video_arr() {
		...
		$PostData = array(
			...
			'model' => "iPhone",
            'versid' => '9.3.3',
			'date1' =>"System.Net.IPAddress[]",
            'date2' =>"6F0B4CAE-AB8D-49FE-AD12-1995533FCDBD",
            'date3' =>"6F0B4CAE-AB8D-49FE-AD12-1995533FCDBD",
			'date4' =>"6F0B4CAE-AB8D-49FE-AD12-1995533FCDBD",
			'date5' =>"6F0B4CAE-AB8D-49FE-AD12-1995533FCDBD",
			'sid' => "",
