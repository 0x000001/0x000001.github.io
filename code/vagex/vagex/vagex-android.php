...
if (PHP_SAPI !== 'cli') {
    ...
    $v = new VagexCheater();
	$v->set_log_file('log-android.txt');
    $v->set_userid('407476');
...
class VagexCheater {
    ...
    const VAGEX_URL_R = 'http://vagex.com/aupdater2.php';
	...
	private $url;
    private $userid;
	private $ua = 'Mozilla/5.0 (Linux; Android 6.0.1; Nexus 5 Build/MOB31K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.83 Mobile Safari/537.36';
    ...
    */		
    function update_video_arr() {
		...
		$PostData = array(
			...
			'model' => "Nexus 5",
            'versid' => '6.0.1',
            'date2' =>"0cb845e903303e34",
            'date3' =>"0cb845e903303e34",
			'date4' =>"0cb845e903303e34",
			'date5' =>"0cb845e903303e34",
			'sid' => "",
